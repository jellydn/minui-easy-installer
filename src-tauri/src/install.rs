...
mod tests {
    ...
    async fn test_install_minui_with_cancel_full_pipeline() {
        ...
        let progress_events: Arc<Mutex<Vec<InstallProgressEvent>>> =
        ...
        assert_eq!(fs::read_to_string(sd_root.join("MinUI.zip")).unwrap(), "minui");
        ...
        assert_eq!(fs::read_to_string(sd_root.join("minui.txt")).unwrap(), "MinUI 2025.01.01\n");
